...
public class JsonSchema : IBaseDocument
{
	...
	private readonly ConcurrentDictionary<EvaluationOptions?, OptionsDerivedValues> _cache = new();
...
#pragma warning disable CS8622 // Factory does not need to handle null since GetOrAdd will throw if key is null
		var optionsDerivedValues = _cache.GetOrAdd(options ?? EvaluationOptions.Default, OptionsDerivedValuesFactory);
